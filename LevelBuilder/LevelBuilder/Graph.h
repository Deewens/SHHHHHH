...
public:
    ...
    void ucs(Node* start, Node* goal, std::vector<Node*>& path);
...
template<typename NodeType, typename ArcType>
void Graph<NodeType, ArcType>::removeAllArcs()
{
 ...
 */
template<class NodeType, class ArcType>
void Graph<NodeType, ArcType>::ucs(Graph::Node* start, Graph::Node* goal, std::vector<Node*>& path)
{
